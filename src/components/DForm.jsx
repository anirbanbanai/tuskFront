      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-8 p-5">
            ...
            <div className="mt-10">
              ...
              <div>
                ...
                <Checkbox
                  ...
                  onClick={() => setValueShare("1")}
                  {...register("feedbackchannel")}
                  checked={selectedOptionN === "Bangladeshi"}
                  onChange={() => handleShareCheckboxChange("Bangladeshi")}
                />
                <Checkbox
                  color="blue"
                  label="Foreigner"
                  ...
                  onClick={() => setValueShare("0")}
                  {...register("feedbackchannel")}
                  checked={selectedOptionN === "Foreigner"}
                  onChange={() => handleShareCheckboxChange("Foreigner")}
                />
                </div>
        ...
        <div className="flex flex-col mb-5 ">
          ...
          <div className="flex gap-2 items-center">
            <div className="w-5 h-5 rounded-full border-4 border-gray-400">
              <h1 className="w-3 h-3 bg-blue-500 rounded-full " />
            </div>
            Service request
          </div>
          ...
          <div className="flex gap-2 items-center">
            <div className="w-5 h-5 rounded-full border-4 border-gray-400">
              <h1 className="w-3 h-3 bg-white rounded-full " />
            </div>
            Information request
          </div>
          <div className="flex gap-2 items-center">
        ...
        <div className="flex flex-col mb-5 ">
          ...
          <div className="flex gap-2 items-center">
            ...
            Misbehave, fraud and corruption by BDRCS Staff or Volunteer
          </div>
          <div className="flex gap-2 items-center">
            <div className="w-5 h-5 rounded-full border-4 border-gray-400">
              <h1 className="w-3 h-3 bg-white rounded-full " />
